...
namespace HotelApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            switch (opcionElegido)
            {
                ...
                case 2:
                    ...
                    string DNI = IfDniExists(Console.ReadLine());
                    EditClient(DNI);
                    break;
                case 3:
                    CheckIn();
        ...
        static string CheckDNI(string dni)
        {
            while(dni.Length < 9)
            {
        ...
        static string IfDniExists(string DNI)
        {
            conexion.Open();
        ...
        static void EditClient(string DNI)
        {
        ...
        static void Reservation(string DNI, int RoomCode,string CheckInDate,string CheckOutDate)
        {
            conexion.Open();
        ...
        static bool ChangeRoomToBusy(int RoomCode)
        {
            try
            {
        ...
        static string returnRoomCodeFromReservation(string DNI)
        {
        ...
        static void ShowRoomsWithGuesInfo()
        {
